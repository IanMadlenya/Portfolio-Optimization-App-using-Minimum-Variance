...
class MinimumVariancePortfolioTest < ActiveSupport::TestCase
  ...
  def test_portfolio1
    ...
    weights.each_with_index do |weight, i|
      assert_in_delta( weight, actual_results[i], delta, message = "exceeded tolerance" )
    end
  end
  ...
  def test_portfolio3
    ...
    # µ2 = 0.15, s2 = 0.24 -> var2 = s1^2 = 0.24^2 = 0.0576
    # µ3 = 0.20, s3 = 0.25 -> var3 = s1^2 = 0.25^2 = 0.0625
    #
    # Solution:
